...
public class MagicValues {
    ...
    static {
        ...
        register(MobType.MOOSHROOM_COW, 96);
        register(MobType.SNOWMAN, 97);
        register(MobType.OZELOT, 98);
        register(MobType.VILLAGER_GOLEM, 99);
